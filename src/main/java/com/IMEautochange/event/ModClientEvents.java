...
public class ModClientEvents {
    ...
    public static void KeyInputEventHandler(InputEvent.KeyInputEvent event)
    {
	...
	@SideOnly(Side.CLIENT)
	@SubscribeEvent//(priority = EventPriority.HIGHEST)
	public static void GuiChatKeyboardInputEventHandler(KeyboardInputEvent.Pre event)
	{
